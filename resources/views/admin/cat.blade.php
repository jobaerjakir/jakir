                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" action="{{$url}}">
                      ...
                      <div class="form-group">
                        <label for="exampleInputUsername1">{{$title}} Category Name</label>
                        <input
                          type="text"
                          class="form-control"
                          ...
                          value="{{$title == 'Update' ? $categories->category_name : ''}}"
                        />
                      </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tbody>
                          @if(!empty($categories) and $title=="Add")
                            @foreach($categories as $category)
                            <tr>
                              <td>{{$loop->iteration}}</td>
                              <td>{{$category->category_name}}</td>
                              <td>
                                <a href="{{url('update/'.$category->id)}}">
